...
<br><br>
	...
	<li class="active"><a data-toggle="pill" href="#viewdiscussions">VIEW DISCUSSIONS</a></li>
...
<br><br><br>
  <div class="tab-content">
	...
	<div id="viewdiscussions" class="tab-pane fade in active" style="text-align: justified;">
